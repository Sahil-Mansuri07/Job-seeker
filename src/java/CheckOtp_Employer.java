 ...
 * @author sahil
 */
@WebServlet(urlPatterns = {"/CheckOtp_Employer"})
public class CheckOtp_Employer extends HttpServlet {
...
"    </style>   </head>");
       ...
       String msg="Please click this link to reset your password"+" http://localhost:8084/JProject_by_Sahil/editPassword_employer.jsp?mail="+email2;    
