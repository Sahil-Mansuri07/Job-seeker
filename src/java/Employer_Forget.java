 ...
 * @author sahil
 */
@WebServlet(urlPatterns = {"/Employer_Forget"})
public class Employer_Forget extends HttpServlet {
...
"    </style>   </head>");
        ...
        PreparedStatement ps2=cn2.prepareStatement("select * from employer where email=?");
        ps2.setString(1,to);
        //execute the query
       ...
       RequestDispatcher rd=request.getRequestDispatcher("employer_otp.html");
       ...
       out.println(e);
        ...
        RequestDispatcher rd=request.getRequestDispatcher("employer_forget.html");
       rd.include(request, response);
